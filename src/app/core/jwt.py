...
def create_access_token(
    ...
    Args:
        data (dict[str, Any]): Данные для кодирования в токен (payload).
        expires_delta (int | None): Время жизни токена в минутах (по умолчанию из настроек).
...
def decode_access_token(
    ...
    Returns:
        dict[str, Any]: Payload токена, если токен валиден, иначе пустой словарь.
    """
    try:
        payload = jwt.decode(
            token,
...
def create_refresh_token(
    ...
    Args:
        data (dict[str, Any]): Данные для кодирования в токен (payload).
        expires_delta (int | None): Время жизни refresh-токена в минутах (по умолчанию из настроек).
